...
public class DownloadRequest<T: Serializable> : Alamofire.SessionManager {
    ...
    internal var successCallback: DownloadSuccess<T>?
    ...
    init(url: String, method: HTTPMethod, outputType: T.Type, jsonKeys: [String]? = nil) {
...
//        }
    ...
    // MARK: -
    // MARK: INIT DOWNLOAD REQUEST
    init(url: String, method: HTTPMethod, outputType: T.Type, jsonKeys: [String]? = nil, headers : [String:String]) {
